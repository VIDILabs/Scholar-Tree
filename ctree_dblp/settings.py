"""
Django settings for ctree_dblp project.
...
ALLOWED_HOSTS = ['*']
#ALLOWED_HOSTS = ['localhost', '127.0.0.1'] TODO CHANGE BACK
...
ROOT_URLCONF = 'ctree_dblp.urls'

WSGI_APPLICATION = 'ctree_dblp.wsgi.application'
